          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      FoodInfo(
                          ...
                          value: "${widget.foodData.cal} Calorias"),
                      const FoodInfo(
                ...
                Text(
                  "Prato delicioso, rico em proteinas e Carboidratos.",
                  style: _grayText(),
                ),
                const SizedBox(
                  height: 15,
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(">  Arroz Integral", style: _grayText()),
                      Text(">  Frango Grelhado", style: _grayText()),
                      Text(">  Salada Mista", style: _grayText()),
                      Text(">  Purê de Batata", style: _grayText()),
                    ],
                  ),
                )
              ],
